...
typedef struct {
       ...
       unsigned long BaseRpm;     		// Parameter: Base speed in rpm (Q0) - independently with global Q
       ...
       long EstimatedSpeedRpm; // Output : Estimated speed in rpm  (Q0) - independently with global Q
