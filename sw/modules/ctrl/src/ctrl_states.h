...
//!
typedef enum {
  CTRL_State_Offline = 0,            //!< the controller idle state
  CTRL_State_Idle,            //!< the controller idle state
  CTRL_State_ForceAngle,        //!< the controller offline state
  CTRL_State_OpenLoop,          //!< the controller offline state
  CTRL_State_OnLine,            //!< the controller online state
  CTRL_State_Error,             //!< the controller error state
